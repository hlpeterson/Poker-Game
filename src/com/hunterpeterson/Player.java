...
public class Player {
    ...
    protected static String[][] allCards = {{"Ace of clubs", "Two of clubs", "Three of clubs", "Four of clubs", "Five of clubs", "Six of clubs", "Seven of clubs", "Eight of clubs", "Nine of clubs", "Ten of clubs", "Jack of clubs", "Queen of clubs", "King of clubs"},
            ...
            {"Ace of hearts", "Two of hearts", "Three of hearts", "Four of hearts", "Five of hearts", "Six of hearts", "Seven of hearts", "Eight of hearts", "Nine of hearts", "Ten of hearts", "Jack of hearts", "Queen of hearts", "King of hearts"},
            {"Ace of spades", "Two of spades", "Three of spades", "Four of spades", "Five of spades", "Six of spades", "Seven of spades", "Eight of spades", "Nine of spades", "Ten of spades", "Jack of spades", "Queen of spades", "King of spades"}};
    protected static String[][] cardImages = {{"card-images/A Clubs.png", "card-images/2 Clubs.png", "card-images/3 Clubs.png", "card-images/4 Clubs.png", "card-images/5 Clubs.png", "card-images/6 Clubs.png", "card-images/7 Clubs.png", "card-images/8 Clubs.png", "card-images/9 Clubs.png", "card-images/10 Clubs.png", "card-images/J Clubs.png", "card-images/Q Clubs.png", "card-images/K Clubs.png"},
            {"card-images/A Diamond.png", "card-images/2 Diamond.png", "card-images/3 Diamond.png", "card-images/4 Diamond.png", "card-images/5 Diamond.png", "card-images/6 Diamond.png", "card-images/7 Diamond.png", "card-images/8 Diamond.png", "card-images/9 Diamond.png", "card-images/10 Diamond.png", "card-images/J Diamond.png", "card-images/Q Diamond.png", "card-images/K Diamond.png"},
            {"card-images/A Hearts.png", "card-images/2 Hearts.png", "card-images/3 Hearts.png", "card-images/4 Hearts.png", "card-images/5 Hearts.png", "card-images/6 Hearts.png", "card-images/7 Hearts.png", "card-images/8 Hearts.png", "card-images/9 Hearts.png", "card-images/10 Hearts.png", "card-images/J Hearts.png", "card-images/Q Hearts.png", "card-images/K Hearts.png"},
            {"card-images/A Spades.png", "card-images/2 Spades.png", "card-images/3 Spades.png", "card-images/4 Spades.png", "card-images/5 Spades.png", "card-images/6 Spades.png", "card-images/7 Spades.png", "card-images/8 Spades.png", "card-images/9 Spades.png", "card-images/10 Spades.png", "card-images/J Spades.png", "card-images/Q Spades.png", "card-images/K Spades.png"}};
